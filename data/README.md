# Data Directory (Not Tracked in Git)

This folder is for local and cloud-stored datasets used in the project.  
Large files are not uploaded to GitHub to keep the repository lightweight.

## Data Sources
| Dataset | File Name | Access / Download Link |
|----------|------------|------------------------|
| CAP LTER Environmental Data | 647_IET_measurements_50e72be656c7407bd07e36061beeb1d.csv | [CAP LTER Portal](https://portal.edirepository.org/nis/mapbrowse?packageid=knb-lter-cap.647.1) |
